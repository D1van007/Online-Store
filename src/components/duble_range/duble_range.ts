...
function getdubleRangeHTML(options:DubleRangeOptions):string{
  ...
  <div class="duble-range">
    <input class="duble-range__input duble-range__i1" type="range" min="${options.min}" max="${options.max}" step="${options.max/100}" value="${options.min}">
    <input class="duble-range__input duble-range__i2" type="range" min="${options.min}" max="${options.max}" step="${options.max/100}" value="${options.max}">
